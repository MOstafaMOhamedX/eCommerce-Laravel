    ...
    public function run()
    {
        ...
        for ($i=1; $i <= 30; $i++) {
            Product::create([
                ...
                'price' => rand(149999, 249999) . '.' . rand(01, 99),
        ...
        for ($i = 1; $i <= 9; $i++) {
            Product::create([
                ...
                'price' => rand(249999, 449999) . '.' . rand(01, 99),
                'description' => 'Lorem ' . $i . ' ipsum dolor sit amet, consectetur adipisicing elit. Ipsum temporibus iusto ipsa, asperiores voluptas unde aspernatur praesentium in? Aliquam, dolore!',
        ...
        for ($i = 1; $i <= 9; $i++) {
            Product::create([
                ...
                'price' => rand(79999, 149999) . '.' . rand(01, 99),
                'description' => 'Lorem ' . $i . ' ipsum dolor sit amet, consectetur adipisicing elit. Ipsum temporibus iusto ipsa, asperiores voluptas unde aspernatur praesentium in? Aliquam, dolore!',
        ...
        for ($i = 1; $i <= 9; $i++) {
            Product::create([
                ...
                'price' => rand(49999, 149999) . '.' . rand(01, 99),
                'description' => 'Lorem ' . $i . ' ipsum dolor sit amet, consectetur adipisicing elit. Ipsum temporibus iusto ipsa, asperiores voluptas unde aspernatur praesentium in? Aliquam, dolore!',
        ...
        for ($i = 1; $i <= 9; $i++) {
            Product::create([
                ...
                'price' => rand(79999, 249999) . '.' . rand(01, 99),
                'description' => 'Lorem ' . $i . ' ipsum dolor sit amet, consectetur adipisicing elit. Ipsum temporibus iusto ipsa, asperiores voluptas unde aspernatur praesentium in? Aliquam, dolore!',
